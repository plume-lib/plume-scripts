...
READLINK_DOT_PLUME_SCRIPTS := $(shell $$(readlink -f .plume-scripts))
DMDL := docker run -w /myfolder -v $$PWD:/myfolder -v $$READLINK_DOT_PLUME_SCRIPTS:/plume-scripts davidanson/markdownlint-cli2:v0.20.0
...
$(info $(shell docker run --entrypoint /bin/sh -w /myfolder -v $$PWD:/myfolder -v $$READLINK_DOT_PLUME_SCRIPTS:/plume-scripts davidanson/markdownlint-cli2:v0.20.0 -c pwd))
$(info docker run --entrypoint /bin/sh -w /myfolder -v $$PWD:/myfolder -v $$READLINK_DOT_PLUME_SCRIPTS:/plume-scripts davidanson/markdownlint-cli2:v0.20.0 -c pwd)
$(info $(shell docker run --entrypoint /bin/sh -w /myfolder -v $$PWD:/myfolder -v $$READLINK_DOT_PLUME_SCRIPTS:/plume-scripts davidanson/markdownlint-cli2:v0.20.0 -c ls -al))
$(info docker run --entrypoint /bin/sh -w /myfolder -v $$PWD:/myfolder -v $$READLINK_DOT_PLUME_SCRIPTS:/plume-scripts davidanson/markdownlint-cli2:v0.20.0 -c ls -al)
$(info $(shell docker run --entrypoint /bin/sh -w /myfolder -v $$PWD:/myfolder -v $$READLINK_DOT_PLUME_SCRIPTS:/plume-scripts davidanson/markdownlint-cli2:v0.20.0 -c ls -al /))
$(info docker run --entrypoint /bin/sh -w /myfolder -v $$PWD:/myfolder -v $$READLINK_DOT_PLUME_SCRIPTS:/plume-scripts davidanson/markdownlint-cli2:v0.20.0 -c ls -al /)
$(info $(shell docker run --entrypoint /bin/sh -w /myfolder -v $$PWD:/myfolder -v $$READLINK_DOT_PLUME_SCRIPTS:/plume-scripts davidanson/markdownlint-cli2:v0.20.0 -c ls -al /myfolder))
$(info docker run --entrypoint /bin/sh -w /myfolder -v $$PWD:/myfolder -v $$READLINK_DOT_PLUME_SCRIPTS:/plume-scripts davidanson/markdownlint-cli2:v0.20.0 -c ls -al /myfolder)
$(info $(shell docker run --entrypoint /bin/sh -w /myfolder -v $$PWD:/myfolder -v $$READLINK_DOT_PLUME_SCRIPTS:/plume-scripts davidanson/markdownlint-cli2:v0.20.0 -c ls -al /plume-scripts))
$(info docker run --entrypoint /bin/sh -w /myfolder -v $$PWD:/myfolder -v $$READLINK_DOT_PLUME_SCRIPTS:/plume-scripts davidanson/markdownlint-cli2:v0.20.0 -c ls -al /plume-scripts)
endif
